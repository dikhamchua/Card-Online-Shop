...
(function ($) {
  ...
  CartQtyPlusMinus.append('<div class="ms_cart_qtybtn"><div class="inc fa fa-arrow-up ms_qtybtn">+</div><div class="dec ms_qtybtn">-</div></div>');
  ...
  $(document).ready(function () {
    ...
    $('.gi-sidebar-title').append("<div class='gi-sidebar-res'><i class='fas fa-chevron-down'></i></div>");
