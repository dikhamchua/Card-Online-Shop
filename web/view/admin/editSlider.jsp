                    ...
                    <div class="container-fluid">
                        <div class="card mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="slider?action=editSlider" method="POST" enctype="multipart/form-data">
                                    <!--id-->
                                    <div class="form-group" style="display: none">
                                        <input type="text" class="form-control" id="idEditInput" name="id" value="${slider.getID()}" >
                                    </div>
                                    <!--Image-->
                                    <div class="form-group">
                                        ...
                                        <img id="previewImage2" src="${slider.getImage()}" alt="Preview"
                                             style="display: block; max-width: 300px; max-height: 300px;">
                                        <input type="hidden" id="currentImage" name="currentImage" value="${slider.getImage()}">
                                    </div>
