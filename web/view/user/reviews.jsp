...
<html lang="en">
    <head>
        ...
        <title>CardLord-Trading - Đánh giá dịch vụ</title>
        <meta name="keywords" content="cardlord, trading, đánh giá, dịch vụ">
        <meta name="description" content="Đánh giá dịch vụ CardLord-Trading">
        ...
        <jsp:include page="../common/homepage/header.jsp"></jsp:include>
            ...
            <div class="container mx-auto px-4 py-8">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-center text-2xl font-semibold text-[#FF1493] mb-6">Đánh giá sản phẩm</h2>
                ...
                <div>
                    ...
                    <p><strong>Tổng tiền:</strong> ${param.totalMoney}</p>
                    <p><strong>Ngày mua:</strong> ${param.orderDate}</p>
                ...
                <form action="${pageContext.request.contextPath}/UserReviewsServlet?action=add" method="post" class="mt-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="title" name="title" rows="4" class="form-textarea mt-1 block w-full textarea-border"></textarea>
                    </div>
