                    ...
                    <div class="container-fluid">
                        <div class="card mb-3">
                            ...
                            <div class="card">
                                ...
                                <form action="${pageContext.request.contextPath}/admin/news?action=addNews" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                                    <!--Title-->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-lg" id="content" name="content" rows="10" required></textarea>
                                    </div>
                                    <!--Image-->
                                    <div class="form-group">
                                    ...
                                    <!--Button-->
                                    <button type="submit" class="btn btn-primary btn-create-post">Đăng bài viết</button>
                                </form>
                            </div>
                        </div>
                    </div>
